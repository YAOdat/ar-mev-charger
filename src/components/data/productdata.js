  export const products = [
    {
      ...
      color: [
        ...
        { name: 'أبيض', imageUrl: 'https://iili.io/HrjMgs9.webp' },
        { name: 'أزرق', imageUrl: 'https://iili.io/HrjMhfn.md.webp' },
      ],
    ...
    },
    {
      ...
      },
      {
        ...
        longDescription: `
        شاحن المنزل للسيارات الكهربائية Type 2 هو منتج يسهل عملية شحن سيارتك الكهربائية في منزلك بكل سرعة وسهولة. مع هذا الشاحن، لن تضطر للقلق بشأن العثور على محطة شحن عامة، بل يمكنك شحن سيارتك بالكامل في راحة منزلك.
        
        يتميز هذا الشاحن بمجموعة من الميزات الرائعة التي تسهل عملية الشحن وتوفر الراحة. يحتوي الشاحن على شاشة تعرض معلومات حالة الشحن، مما يتيح لك مراقبة تقدم الشحن بسهولة. ستتلقى إشارات وتنبيهات متعددة تبين لك متى يكتمل الشحن أو إذا كان هناك أي مشكلة في عملية الشحن.
        ...
        current: '32 A',
        cableLength: '3.5م/5م',
        illustration: require('../images/product-images/mega_feature.png'),
...
`,
      ...
      {
        id: '21',
        name: 'شاحن سيارة مرسيدس كهربائية لجميع سيارات مرسيدس EQV, EQC, EQA, EQS',
        currency: 'AED',
        price: 1600,
        ...
        التوافق الشامل: تم تصميم شاحن مرسيدس بنز الكهربائي ليتناسب مع جميع سيارات مرسيدس بنز الكهربائية التي تأتي مع منفذ الشحن من النوع 2. سواء كنت تمتلك سيارة EQS الفاخرة، أو EQC الرياضية، أو EQA المدمجة، أو EQB المتعددة الاستخدامات، يضمن هذا الشاحن تجربة شحن سلسة لسيارتك الكهربائية.
        
        الشحن المنزلي بتيار متردد مرحلي/ثلاثي المراحل: تم تصميم هذا الشاحن خصيصًا للاستخدام المنزلي، حيث يعمل على كل من تيار المتردد مرحلي وتيار المتردد ثلاثي المراحل، مما يوفر خيارات شحن مرنة تتناسب مع احتياجات توصيلة الكهرباء المنزلية.
        
        الأمان المحسن: لحماية ضد سرقة الكهرباء والاستخدام غير المصرح به، يأتي الشاحن مجهزًا بحامل مقبض مقفل للقابس، مما يوفر طبقة إضافية من الحماية والطمأنينة.
        
        السهولة في التركيب على الحائط: يتميز تصميم المنتج بالبساطة والأناقة، مما يسمح بسهولة تركيبه على الحائط. بفضل حجمه المدمج الذي يشبه حجم ورقة A4، يتناسب الشاحن بسهولة مع أي بيئة منزلية دون استهلاك مساحة زائدة.
        
        حماية ممتازة بتصنيف IP65: يتميز شاحن مرسيدس بنز الكهربائي بتصنيف حماية IP65 المذهل، متجاوزًا المعايير الصناعية. يضمن هذا التصنيف تحمل الشاحن في ظروف بيئية مختلفة، بما في ذلك الأعاصير والعواصف المطرية والبيئات الرملية أو الغبارية. بفضل التصميم المضاد للأشعة فوق البنفسجية، لا توجد حاجة لأجهزة حماية إضافية لتشغيله.
        
        مواد عالية التحمل مقاومة للحرارة العالية: تعتمد تصنيع الشاحن على لوحات بلاستيكية مقاومة للحرارة العالية، مما يضمن المتانة والعمر الطويل حتى في ظروف الطقس القاسية. يتضح التركيز على الجودة والحرفية في تصميمه الأنيق والرائع.
        
        مكونات صناعية الجودة: صُمم هذا الشاحن للأداء في البيئات القاسية، حيث يستخدم مكونات ذات جودة صناعية تمنحه عمر تصميم يصل إلى 15 عامًا. يمكنه العمل بشكل موثوق في درجات حرارة منخفضة تصل إلى -30 درجة مئوية في ظروف الصقيع، أو في درجات حرارة تصل إلى 55 درجة مئوية في الصحاري الحارة.
        
        شاحن سيارات مرسيدس بنز الكهربائي هو عبارة عن دليل على التزام مرسيدس بنز بالاستدامة والراحة والابتكار. يقدم تجربة شحن سلسة وآمنة، مما يسمح لأصحاب سيارات مرسيدس بنز الكهربائية بالاستمتاع بسياراتهم بأقصى قدر ممكن والمساهمة في مستقبل أكثر صفاءً للبيئة. احتضن مستقبل النقل بمساعدة هذا الحلا الحديث لشحن السيارات الكهربائية من مرسيدس بنز.`,
        ...
        {
          id: '23',
          name: 'شاحن سيارة شانجان الكهربائية - شاحن ميجا',
          currency: 'AED',
          price: 1550,
          ...
          1. **سرعة الشحن**: يوفر هذا الشاحن سرعات شحن فائقة، مما يقلل من وقت الانتظار ويسمح بشحن البطارية بشكل سريع وفعال.
          
          2. **متوافقية واسعة**: يمكن لشاحن ميجا شحن مجموعة متنوعة من سيارات شانجان الكهربائية، مما يجعله اختيارًا مناسبًا للعديد من الموديلات.
          
          3. **سهولة الاستخدام**: تم تصميم واجهة الشاحن بشكل بسيط وسهل الاستخدام، مما يسهل عملية التوصيل والشحن للمستخدمين.
          
          4. **حماية متقدمة**: يتضمن الشاحن آليات حماية متقدمة لضمان سلامة البطارية والجهاز أثناء عملية الشحن، مما يقلل من مخاطر التلف أو الأعطال.
          
          5. **تصميم عملي**: بفضل تصميمه الصغير والمدمج، يسهل حمل وتخزين الشاحن معك أثناء السفر أو في حالات الاستخدام اليومي.
          
          6. **تقنيات متقدمة**: يعتمد الشاحن على تقنيات حديثة تساعد في تحسين كفاءة الشحن وتوزيع الطاقة بشكل متساوي على البطارية.
          
          باستخدام شاحن سيارة شانجان الكهربائية - شاحن ميجا، يمكنك الاعتماد على تجربة شحن موثوقة وسريعة لبطارية سيارتك الكهربائية، مما يسهم في الحفاظ على أداء السيارة بأفضل حالاته وتقليل الوقت اللازم لإعادة شحنها.`,
          function: 'adapter',
          illustration: require('../images/product-images/Changan-EV-2.jpg'),
          current:' 32 أمبير',
          availablePorts: 'GB/T',
          weight: '6 كيلوغرام',
